...
cons:       ;
                encoded_exponent = bias - exponent;
                // goto done 
            } else {
other:      ;
                encoded_exponent = bias + exponent;
...
dec:        ;
            ...
            coefficient_shift = 33; // location where whole number gets removed
            coefficient_shift = coefficient_shift - position; // subtract position for exact shifts required
...
// Taske 1 complete: Tue Oct 24 16:41:44 PDT 2023

// Task 2 complete: Tue Oct 24 17:52:30 PDT 2023

// Task 2 complete: Tue Oct 24 20:06:49 PDT 2023
